...
<div class="wrap">
    <h1 class="wp-heading-inline">New Blog Posting Order</h1>
    ...
    <form name="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" id="post">
        <input type="hidden" name="action" value="clwp_create_blog_posting_order">
                ...
                <div id="post-body-content" style="position: relative;">
                    ...
                    <div id="titlediv">
                        <div id="titlewrap">
                            ...
                            <input type="text" class="clwp_bp_price_update" name="project_name" size="30" value="" id="title" spellcheck="true">
                        </div>
                        <br/>
                        <div id="titlewrap">
                        ...
                        <div id="titlewrap">
                            ...
                            <input type="text" id="domain" name="domain" value=""  class="clwp_bp_price_update input_field"  spellcheck="true">
                        </div>
                        <br>
                        <label for="">Article language<span class="clwp_required">*</span></label>
                        <select name="lng_code[]" id="source" multiple data-placeholder="Select language" class="js-example-basic-single clwp_source_lng">
							<?php
								if ( $source_lng ) {
                        ...
                        <br>
                        <div id="titlewrap">
                            <label class="">Number of words <span id="words_number_value" style="font-weight: bold">(50)</span><span class="clwp_required">*</span> </label>
                            <input type="range" min="50" max="1000" value="50" step="50" class="wp_slider clwp_bp_price_update" id="words_number" name="words_number">
                        </div>
                        <br>
                        <div id="s">
                            <label class="">Blog post title writing </label>
                            <input type="checkbox" class="clwp_bp_price_update" id="title_needed" name="title_needed" checked value="1">
                        </div>
                        <br>
                        <div id="titlewrap">
...
<div id="overview">
    <div id="delivery_time">
        ...
        <select name="delivery" id="delivery" class="clwp_bp_price_update">
			<?php
				if ( $devilery ) {
